...
Copy the “distribution code” (i.e., starter code) from \[...\] into a new file in your IDE called population.c.
...
## Problem Set 1: Mario - World 1-1

Toward the beginning of World 1-1 in Nintendo’s Super Mario Brothers, Mario must hop over adjacent pyramids of blocks, per the below.

![Super Mario Pyramid](https://github.com/Andreas1593/CS50x/blob/Week-1/images/pyramids.png?raw=true)
